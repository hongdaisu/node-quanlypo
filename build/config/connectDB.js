...
var sequelize = new Sequelize(process.env.DB_DATABASE_NAME_MYSQL, process.env.DB_USERNAME_MYSQL, process.env.DB_PASSWORD_MYSQL, {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          console.error('Lỗi Kết nối đết DB MYSQL:', _context.t0);
        case 9:
        case "end":
