    ...
    var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 7:
            _context5.next = 9;
            return _index["default"].sequelize.query('CALL sp_checklan_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:NamKiemKe)', {
              replacements: {
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
                NamKiemKe: NamKiemKe
...
var getLanKiemKe = function getLanKiemKe() {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee15$(_context15) {
        while (1) switch (_context15.prev = _context15.next) {
          case 0:
            _context15.prev = 0;
            _context15.next = 3;
            return _index["default"].sequelize.query('CALL sp_get_lankiemke', {
              // replacements: { id: 2 },
              raw: false
            });
          case 3:
...
var getAllNguoiSuDung = function getAllNguoiSuDung() {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee18$(_context18) {
        while (1) switch (_context18.prev = _context18.next) {
          case 0:
            ...
            request = _index["default"].sqlhis2Connection.request();
            _context18.next = 4;
            return request.execute('[sp_QLPO_GETALLNGUOISUDUNG]');
          case 4:
            getdata = _context18.sent;
            // Lấy dữ liệu từ recordset
            data = getdata.recordset; //console.log('recordset', data)
            resolve(data);
            _context18.next = 12;
...
var getCheckDongBo = function getCheckDongBo(LanKiemKe, NamKiemKe) {
  return new Promise(/*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19(resolve, reject) {
      var request, getdata, datataisan, datatool, plainDatatool, result;
      return _regeneratorRuntime().wrap(function _callee19$(_context19) {
        while (1) switch (_context19.prev = _context19.next) {
          case 0:
            ...
            _context19.next = 5;
            return request.execute('[sp_QLPO_CHECK_DONGBO]');
          case 5:
            getdata = _context19.sent;
            datataisan = getdata.recordset; // const time = new Date();
            // const NamKiemKe = time.getFullYear();
            //console.log('data', datataisan)
            _context19.next = 9;
            return _index["default"].sequelize.query('CALL sp_getdatatoll(:LanKiemKe,:NamKiemKe)', {
              replacements: {
                LanKiemKe: LanKiemKe,
                NamKiemKe: NamKiemKe
              },
          ...
          case 9:
            datatool = _context19.sent;
            plainDatatool = JSON.parse(JSON.stringify(datatool)); //console.log('datataisan', datataisan)
            //console.log('plainDatatool', plainDatatool)
            result = datataisan.filter(function (dts) {
              return !plainDatatool.some(function (pdt) {
                return pdt.KhoDuoc_Id === dts.KhoDuoc_Id && pdt.KhoaPhongSuDung === dts.KhoaPhongSuDung && pdt.KhoaQuanLy === dts.KhoaQuanLy;
              });
            }); //console.log('result', result)
            // Thêm các đối tượng tìm được vào plainDatatool và gán DaDongBo = 0
            result.forEach(function (dts) {
              // Tìm LanKiemKe giống với LanKiemKe của plainDatatool 
              var lanKiemKe = plainDatatool[0].LanKiemKe;
              // Thêm đối tượng vào plainDatatool với DaDongBo = 0
              plainDatatool.push(_objectSpread(_objectSpread({}, dts), {}, {
                // Sao chép các thuộc tính từ datataisan
                LanKiemKe: lanKiemKe,
                // Giữ lại LanKiemKe
                TrangThai: 'Chưa đồng bộ',
                DaDongBo: 0,
                XacNhanKiemKe: 0
              }));
            });
            plainDatatool.sort(function (a, b) {
              // Sắp xếp theo KhoDuoc_Id trước
              if (a.KhoDuoc_Id !== b.KhoDuoc_Id) {
                return a.KhoDuoc_Id - b.KhoDuoc_Id;
              }

              // // Sau đó sắp xếp theo KhoaPhongSuDung (theo thứ tự bảng chữ cái)
              // if (a.KhoaPhongSuDung !== b.KhoaPhongSuDung) {
              //     return a.KhoaPhongSuDung.localeCompare(b.KhoaPhongSuDung);
              // }

              // Tiếp theo sắp xếp theo LanKiemKe
              if (a.LanKiemKe !== b.LanKiemKe) {
                return a.LanKiemKe - b.LanKiemKe;
              }

              // // Cuối cùng sắp xếp theo KhoaQuanLy (theo thứ tự bảng chữ cái)
              // return a.KhoaQuanLy.localeCompare(b.KhoaQuanLy);
            });

            //console.log('result plainDatatool', plainDatatool)
      ...
      return _regeneratorRuntime().wrap(function _callee26$(_context26) {
        while (1) switch (_context26.prev = _context26.next) {
          ...
          case 35:
            ...
            console.log("Database error:", _context26.t0);
      ...
      return _regeneratorRuntime().wrap(function _callee27$(_context27) {
        while (1) switch (_context27.prev = _context27.next) {
          ...
          case 44:
            ...
            console.log("Database error:", _context27.t0);
...
var importPO = function importPO(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref47 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee46(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee46$(_context46) {
        while (1) switch (_context46.prev = _context46.next) {
          ...
          case 17:
            ...
            console.error("Error finding data for ".concat(sopo, " - ").concat(mataisan, ":"), _context46.t0);
          case 20:
            _context46.next = 8;
            break;
          case 22:
          ...
          case 43:
            _context46.prev = 43;
            _context46.t2 = _context46["catch"](38);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context46.t2.message);
            //return { error: error.message };
            resolve({
              errCode: 1,
              errMessage: 'Không thể import file, vui lòng kiểm tra lại file'
          ...
          case 51:
            _context46.prev = 51;
            _context46.t3 = _context46["catch"](34);
            _iterator2.e(_context46.t3);
          case 54:
            _context46.prev = 54;
            _iterator2.f();
            return _context46.finish(54);
          case 57:
            _context46.next = 63;
            break;
          case 59:
            _context46.prev = 59;
            _context46.t4 = _context46["catch"](31);
            console.error(_context46.t4);
          ...
          case 75:
            _context46.prev = 75;
            _context46.t5 = _context46["catch"](70);
            console.error('Error inserting data:', _context46.t5);
          case 78:
            _context46.next = 68;
            break;
          case 80:
          ...
          case 82:
            _context46.prev = 82;
            _context46.t6 = _context46["catch"](66);
            _iterator3.e(_context46.t6);
          case 85:
            _context46.prev = 85;
            _iterator3.f();
            return _context46.finish(85);
          case 88:
            request = _index["default"].sqlhis2Connection.request();
            _context46.next = 91;
            return request.execute('[sp_QLPO_DANHMUC_VPP]');
          case 91:
            getdata = _context46.sent;
            // Lấy dữ liệu từ recordset
          ...
          case 96:
            check_mataisan_dm = _context46.sent;
          ...
          case 116:
            _context46.prev = 116;
            _context46.t7 = _context46["catch"](105);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item2.id), _context46.t7);
          case 119:
            _context46.next = 103;
            break;
          case 121:
          ...
          case 123:
            _context46.prev = 123;
            _context46.t8 = _context46["catch"](101);
            _iterator4.e(_context46.t8);
          case 126:
            _context46.prev = 126;
            _iterator4.f();
            return _context46.finish(126);
          case 129:
            resolve({
              errCode: 0,
      ...
      }, _callee46, null, [[0, 132], [6, 24, 27, 30], [10, 17], [31, 59], [34, 51, 54, 57], [38, 43], [66, 82, 85, 88], [70, 75], [101, 123, 126, 129], [105, 116]]);
    }));
      ...
      return _regeneratorRuntime().wrap(function _callee47$(_context47) {
        while (1) switch (_context47.prev = _context47.next) {
          ...
          case 17:
            ...
            console.error("Error finding data for ".concat(nhacungcap_id, " - ").concat(mataisan, ":"), _context47.t0);
          case 20:
            _context47.next = 8;
            break;
          case 22:
          ...
          case 43:
            _context47.prev = 43;
            _context47.t2 = _context47["catch"](38);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context47.t2.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể import file, vui lòng kiểm tra lại file'
            });
          ...
          case 51:
            _context47.prev = 51;
            _context47.t3 = _context47["catch"](34);
            _iterator6.e(_context47.t3);
          case 54:
            _context47.prev = 54;
            _iterator6.f();
            return _context47.finish(54);
          case 57:
            _context47.next = 63;
            break;
          case 59:
            _context47.prev = 59;
            _context47.t4 = _context47["catch"](31);
            console.error(_context47.t4);
          ...
          case 75:
            _context47.prev = 75;
            _context47.t5 = _context47["catch"](70);
            console.error('Error inserting data:', _context47.t5); // Log lỗi nếu insert thất bại
          case 78:
            _context47.next = 68;
            break;
          case 80:
          ...
          case 82:
            _context47.prev = 82;
            _context47.t6 = _context47["catch"](66);
            _iterator7.e(_context47.t6);
          case 85:
            _context47.prev = 85;
            _iterator7.f();
            return _context47.finish(85);
          case 88:
            request = _index["default"].sqlhis2Connection.request();
            _context47.next = 91;
            return request.execute('[sp_QLPO_DANHMUC_VPP]');
          ...
          case 96:
            check_mataisan_dm = _context47.sent;
            // Hàm dò tìm và cập nhật checkmataisan
            updateCheckMataisan = function updateCheckMataisan(recordset, check_mataisan_dm) {
              // Dò tìm từng phần tử trong check_mataisan_dm
              check_mataisan_dm.forEach(function (item) {
          ...
          case 116:
            _context47.prev = 116;
            _context47.t7 = _context47["catch"](105);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item4.id), _context47.t7);
          case 119:
            _context47.next = 103;
            break;
          case 121:
          ...
          case 123:
            _context47.prev = 123;
            _context47.t8 = _context47["catch"](101);
            _iterator8.e(_context47.t8);
          case 126:
            _context47.prev = 126;
            _iterator8.f();
            return _context47.finish(126);
          case 129:
          ...
          case 155:
            _context47.prev = 155;
            _context47.t9 = _context47["catch"](145);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item5.id), _context47.t9);
          case 158:
            _context47.next = 143;
            break;
          case 160:
          ...
          case 162:
            _context47.prev = 162;
            _context47.t10 = _context47["catch"](141);
            _iterator9.e(_context47.t10);
          case 165:
            _context47.prev = 165;
            _iterator9.f();
            return _context47.finish(165);
          case 168:
            resolve({
              errCode: 0,
          ...
          case 171:
            _context47.prev = 171;
            _context47.t11 = _context47["catch"](0);
            reject(_context47.t11);
          case 174:
          case "end":
            return _context47.stop();
        }
      }, _callee47, null, [[0, 171], [6, 24, 27, 30], [10, 17], [31, 59], [34, 51, 54, 57], [38, 43], [66, 82, 85, 88], [70, 75], [101, 123, 126, 129], [105, 116], [141, 162, 165, 168], [145, 155]]);
    }));
    ...
    var _ref49 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee48(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee48$(_context48) {
        while (1) switch (_context48.prev = _context48.next) {
          ...
          case 17:
            _context48.prev = 17;
            _context48.t0 = _context48["catch"](10);
            console.error("Error finding data for ".concat(sopr, " - ").concat(mataisan, ":"), _context48.t0);
          case 20:
            _context48.next = 8;
            break;
          case 22:
          ...
          case 24:
            _context48.prev = 24;
            _context48.t1 = _context48["catch"](6);
            _iterator10.e(_context48.t1);
          case 27:
            _context48.prev = 27;
            _iterator10.f();
          ...
          case 43:
            _context48.prev = 43;
            _context48.t2 = _context48["catch"](38);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context48.t2.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể import file, vui lòng kiểm tra lại file'
            });
          ...
          case 51:
            _context48.prev = 51;
            _context48.t3 = _context48["catch"](34);
            _iterator11.e(_context48.t3);
          case 54:
            _context48.prev = 54;
            _iterator11.f();
            return _context48.finish(54);
          case 57:
            _context48.next = 63;
            break;
          case 59:
            _context48.prev = 59;
            _context48.t4 = _context48["catch"](31);
            console.error(_context48.t4);
          ...
          case 75:
            _context48.prev = 75;
            _context48.t5 = _context48["catch"](70);
            console.error('Error inserting data:', _context48.t5); // Log lỗi nếu insert thất bại
          case 78:
            _context48.next = 68;
            break;
          case 80:
          ...
          case 82:
            _context48.prev = 82;
            _context48.t6 = _context48["catch"](66);
            _iterator12.e(_context48.t6);
          case 85:
            _context48.prev = 85;
            _iterator12.f();
            return _context48.finish(85);
          case 88:
            request = _index["default"].sqlhis2Connection.request();
            _context48.next = 91;
            return request.execute('[sp_QLPO_DANHMUC_VPP]');
          ...
          case 96:
            check_mataisan_dm = _context48.sent;
          ...
          case 116:
            _context48.prev = 116;
            _context48.t7 = _context48["catch"](105);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item7.id), _context48.t7);
          case 119:
            _context48.next = 103;
            break;
          case 121:
          ...
          case 123:
            _context48.prev = 123;
            _context48.t8 = _context48["catch"](101);
            _iterator13.e(_context48.t8);
          case 126:
            _context48.prev = 126;
            _iterator13.f();
            return _context48.finish(126);
          case 129:
            resolve({
              errCode: 0,
          ...
          case 132:
            _context48.prev = 132;
            _context48.t9 = _context48["catch"](0);
            reject(_context48.t9);
          case 135:
          case "end":
            return _context48.stop();
        }
      }, _callee48, null, [[0, 132], [6, 24, 27, 30], [10, 17], [31, 59], [34, 51, 54, 57], [38, 43], [66, 82, 85, 88], [70, 75], [101, 123, 126, 129], [105, 116]]);
    }));
    ...
    var _ref50 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee49(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee49$(_context49) {
        while (1) switch (_context49.prev = _context49.next) {
          ...
          case 9:
            check_log_po_pr = _context49.sent;
          ...
          case 27:
            _context49.prev = 27;
            _context49.t0 = _context49["catch"](16);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context49.t0);
          case 30:
            _context49.next = 14;
            break;
          case 32:
          ...
          case 34:
            _context49.prev = 34;
            _context49.t1 = _context49["catch"](12);
            _iterator14.e(_context49.t1);
          case 37:
            _context49.prev = 37;
            _iterator14.f();
            return _context49.finish(37);
          case 40:
            if (!(datapo.length > 0)) {
              _context49.next = 153;
              break;
          ...
          case 70:
            _context49.prev = 70;
            _context49.t2 = _context49["catch"](51);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item10.id), _context49.t2);
          case 73:
            _context49.next = 49;
            break;
          case 75:
          ...
          case 77:
            _context49.prev = 77;
            _context49.t3 = _context49["catch"](47);
            _iterator15.e(_context49.t3);
          case 80:
            _context49.prev = 80;
            _iterator15.f();
          ...
          case 95:
            _context49.prev = 95;
            _context49.t4 = _context49["catch"](90);
            console.error("L\u1ED7i khi x\xF3a d\u1EEF li\u1EC7u v\u1EDBi ID ".concat(record.id, ":"), _context49.t4);
          case 98:
            _context49.next = 88;
            break;
          case 100:
          ...
          case 102:
            _context49.prev = 102;
            _context49.t5 = _context49["catch"](86);
            _iterator16.e(_context49.t5);
          case 105:
            _context49.prev = 105;
            _iterator16.f();
            return _context49.finish(105);
          case 108:
          ...
          case 119:
            _context49.prev = 119;
            _context49.t6 = _context49["catch"](109);
            _iterator17.e(_context49.t6);
          case 122:
            _context49.prev = 122;
            _iterator17.f();
            return _context49.finish(122);
          case 125:
            _context49.next = 150;
            break;
          case 127:
          ...
          case 139:
            _context49.prev = 139;
            _context49.t7 = _context49["catch"](129);
            _iterator18.e(_context49.t7);
          case 142:
            _context49.prev = 142;
            _iterator18.f();
            return _context49.finish(142);
          case 145:
            _context49.next = 150;
            break;
          case 147:
            _context49.prev = 147;
            _context49.t8 = _context49["catch"](127);
            console.error("Lỗi khi insert vào DB:", _context49.t8);
          case 150:
            resolve({
              errCode: 0,
          ...
          case 156:
            _context49.prev = 156;
            _context49.t9 = _context49["catch"](0);
            reject(_context49.t9);
          case 159:
          case "end":
            return _context49.stop();
        }
      }, _callee49, null, [[0, 156], [12, 34, 37, 40], [16, 27], [47, 77, 80, 83], [51, 70], [86, 102, 105, 108], [90, 95], [109, 119, 122, 125], [127, 147], [129, 139, 142, 145]]);
    }));
    ...
    var _ref52 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee51(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee51$(_context51) {
        while (1) switch (_context51.prev = _context51.next) {
          ...
          case 11:
            check_log_chungtu = _context51.sent;
            _context51.next = 14;
          ...
          case 14:
            check_log_hopdong = _context51.sent;
            if (data.trangthai === 'PNDNK') {
              resolve({
                errCode: 1,
                errMessage: 'Chứng từ đã xác nhận nhập kho'
    ...
    var _ref53 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee52(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee52$(_context52) {
        while (1) switch (_context52.prev = _context52.next) {
          ...
          case 3:
            check_log_chungtu = _context52.sent;
            _context52.next = 6;
          ...
          case 6:
            check_log_hopdong = _context52.sent;
            if (check_log_chungtu.length === 0 && check_log_hopdong.length === 0) {
              resolve({
                errCode: 0,
                errMessage: 'Chứng từ chưa nhập kho'
    ...
    var _ref56 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee55(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee55$(_context55) {
        while (1) switch (_context55.prev = _context55.next) {
          ...
          case 11:
            check_log_chungtu_hd = _context55.sent;
          ...
          case 28:
            _context55.prev = 28;
            _context55.t0 = _context55["catch"](18);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context55.t0);
          case 31:
            _context55.next = 16;
            break;
          case 33:
          ...
          case 35:
            _context55.prev = 35;
            _context55.t1 = _context55["catch"](14);
            _iterator19.e(_context55.t1);
          case 38:
            _context55.prev = 38;
            _iterator19.f();
            return _context55.finish(38);
          case 41:
          ...
          case 73:
            _context55.prev = 73;
            _context55.t2 = _context55["catch"](52);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item13.id), _context55.t2);
          case 76:
            _context55.next = 50;
            break;
          case 78:
          ...
          case 80:
            _context55.prev = 80;
            _context55.t3 = _context55["catch"](48);
            _iterator20.e(_context55.t3);
          case 83:
            _context55.prev = 83;
            _iterator20.f();
            return _context55.finish(83);
          case 86:
          ...
          case 98:
            _context55.prev = 98;
            _context55.t4 = _context55["catch"](93);
            console.error("L\u1ED7i khi x\xF3a d\u1EEF li\u1EC7u v\u1EDBi ID ".concat(record.id, ":"), _context55.t4);
          case 101:
            _context55.next = 91;
            break;
          case 103:
          ...
          case 105:
            _context55.prev = 105;
            _context55.t5 = _context55["catch"](89);
            _iterator21.e(_context55.t5);
          case 108:
            _context55.prev = 108;
            _iterator21.f();
            return _context55.finish(108);
          case 111:
            // insert lại thông tin mới    
          ...
          case 122:
            _context55.prev = 122;
            _context55.t6 = _context55["catch"](112);
            _iterator22.e(_context55.t6);
          case 125:
            _context55.prev = 125;
            _iterator22.f();
            return _context55.finish(125);
          case 128:
            _context55.next = 153;
            break;
          case 130:
          ...
          case 142:
            _context55.prev = 142;
            _context55.t7 = _context55["catch"](132);
            _iterator23.e(_context55.t7);
          case 145:
            _context55.prev = 145;
            _iterator23.f();
            return _context55.finish(145);
          case 148:
            _context55.next = 153;
            break;
          case 150:
            _context55.prev = 150;
            _context55.t8 = _context55["catch"](130);
            console.error("Lỗi khi insert vào DB:", _context55.t8);
          case 153:
            resolve({
              errCode: 0,
              errMessage: 'Kiểm tra dữ liệu thành công'
          ...
          case 162:
            _context55.prev = 162;
            _context55.t9 = _context55["catch"](0);
            reject(_context55.t9);
          case 165:
          case "end":
            return _context55.stop();
        }
      }, _callee55, null, [[0, 162], [14, 35, 38, 41], [18, 28], [48, 80, 83, 86], [52, 73], [89, 105, 108, 111], [93, 98], [112, 122, 125, 128], [130, 150], [132, 142, 145, 148]]);
    }));
    ...
    var _ref57 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee56(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee56$(_context56) {
        while (1) switch (_context56.prev = _context56.next) {
          ...
          case 11:
            check_log_chungtu_hd = _context56.sent;
            if (!(check_log_chungtu_hd.length > 0)) {
              _context56.next = 41;
              break;
            }
          ...
          case 28:
            _context56.prev = 28;
            _context56.t0 = _context56["catch"](18);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context56.t0);
          case 31:
            _context56.next = 16;
            break;
          case 33:
          ...
          case 35:
            _context56.prev = 35;
            _context56.t1 = _context56["catch"](14);
            _iterator24.e(_context56.t1);
          case 38:
            _context56.prev = 38;
            _iterator24.f();
            return _context56.finish(38);
          case 41:
            if (!(recordset.length > 0)) {
              _context56.next = 233;
              break;
          ...
          case 73:
            _context56.prev = 73;
            _context56.t2 = _context56["catch"](52);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item18.id), _context56.t2);
          case 76:
            _context56.next = 50;
            break;
          case 78:
          ...
          case 80:
            _context56.prev = 80;
            _context56.t3 = _context56["catch"](48);
            _iterator25.e(_context56.t3);
          case 83:
            _context56.prev = 83;
            _iterator25.f();
            return _context56.finish(83);
          case 86:
            // Dò tìm và thêm id_data_hd từ gethd vào recordset
            recordset.forEach(function (record) {
              var found = gethd.find(function (hd) {
          ...
          case 98:
            _context56.prev = 98;
            _context56.t4 = _context56["catch"](93);
            console.error("L\u1ED7i khi x\xF3a d\u1EEF li\u1EC7u v\u1EDBi ID ".concat(record.id, ":"), _context56.t4);
          case 101:
            _context56.next = 91;
            break;
          case 103:
          ...
          case 105:
            _context56.prev = 105;
            _context56.t5 = _context56["catch"](89);
            _iterator26.e(_context56.t5);
          case 108:
            _context56.prev = 108;
            _iterator26.f();
            return _context56.finish(108);
          case 111:
            // insert lại thông tin mới    
          ...
          case 122:
            _context56.prev = 122;
            _context56.t6 = _context56["catch"](112);
            _iterator27.e(_context56.t6);
          case 125:
            _context56.prev = 125;
            _iterator27.f();
            return _context56.finish(125);
          case 128:
          ...
          case 131:
            data_check_log_chungtu = _context56.sent;
            _context56.next = 134;
            return _index["default"].Data_ChungTu_Hd_Log.findAll({
          ...
          case 134:
            data_log_chungtu = _context56.sent;
          ...
          case 152:
            _context56.prev = 152;
            _context56.t7 = _context56["catch"](141);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item15.id), _context56.t7);
          case 155:
            _context56.next = 139;
            break;
          case 157:
          ...
          case 159:
            _context56.prev = 159;
            _context56.t8 = _context56["catch"](137);
            _iterator28.e(_context56.t8);
          case 162:
            _context56.prev = 162;
            _iterator28.f();
            return _context56.finish(162);
          case 165:
            _context56.next = 227;
            break;
          case 167:
          ...
          case 179:
            _context56.prev = 179;
            _context56.t9 = _context56["catch"](169);
            _iterator29.e(_context56.t9);
          case 182:
            _context56.prev = 182;
            _iterator29.f();
            return _context56.finish(182);
          case 185:
            _context56.next = 190;
            break;
          case 187:
            _context56.prev = 187;
            _context56.t10 = _context56["catch"](167);
            console.error("Lỗi khi insert vào DB:", _context56.t10);
          case 190:
            //SO SÁNH LẦN CHECK LOG HD 1 VÀ CHECK LOG HD 2 ĐỀ TÌM RA KHÁC NHAU
          ...
          case 193:
            _data_check_log_chungtu = _context56.sent;
            _context56.next = 196;
            return _index["default"].Data_ChungTu_Hd_Log.findAll({
              attributes: ['id_data_hd', 'mataisan', 'dongianhap_check', 'dongianhapvat_check'],
              where: {
          ...
          case 196:
            _data_log_chungtu = _context56.sent;
            //console.log('data_check_log_chungtu', data_check_log_chungtu)
            //console.log('data_log_chungtu', data_log_chungtu)
          ...
          case 214:
            _context56.prev = 214;
            _context56.t11 = _context56["catch"](203);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item17.id), _context56.t11);
          case 217:
            _context56.next = 201;
            break;
          case 219:
          ...
          case 221:
            _context56.prev = 221;
            _context56.t12 = _context56["catch"](199);
            _iterator30.e(_context56.t12);
          case 224:
            _context56.prev = 224;
            _iterator30.f();
            return _context56.finish(224);
          case 227:
            resolve({
              errCode: 0,
              errMessage: 'Kiểm tra dữ liệu thành công'
          ...
          case 236:
            _context56.prev = 236;
            _context56.t13 = _context56["catch"](0);
            reject(_context56.t13);
          case 239:
          case "end":
            return _context56.stop();
        }
      }, _callee56, null, [[0, 236], [14, 35, 38, 41], [18, 28], [48, 80, 83, 86], [52, 73], [89, 105, 108, 111], [93, 98], [112, 122, 125, 128], [137, 159, 162, 165], [141, 152], [167, 187], [169, 179, 182, 185], [199, 221, 224, 227], [203, 214]]);
    }));
    ...
    var _ref58 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee57(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee57$(_context57) {
        while (1) switch (_context57.prev = _context57.next) {
          ...
          case 12:
            check_log_chungtu = _context57.sent;
            _context57.next = 15;
            return _index["default"].Data_ChungTu_Hd_Log.findAll({
              //attributes: ['SoBenhAn'],
              where: {
          ...
          case 15:
            check_log_hopdong = _context57.sent;
            _context57.next = 18;
          ...
          case 38:
            _context57.prev = 38;
            _context57.t0 = _context57["catch"](33);
            console.error("Error deleting record with", _context57.t0);
          case 41:
            _context57.next = 31;
            break;
          case 43:
          ...
          case 45:
            _context57.prev = 45;
            _context57.t1 = _context57["catch"](29);
            _iterator31.e(_context57.t1);
          case 48:
            _context57.prev = 48;
            _iterator31.f();
            return _context57.finish(48);
          case 51:
            _context57.next = 53;
            return _index["default"].Data_PO.findAll({
              //attributes: ['SoBenhAn'],
          ...
          case 82:
            _context57.prev = 82;
            _context57.t2 = _context57["catch"](61);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item21.id), _context57.t2);
          case 85:
            _context57.next = 59;
            break;
          case 87:
          ...
          case 89:
            _context57.prev = 89;
            _context57.t3 = _context57["catch"](57);
            _iterator32.e(_context57.t3);
          case 92:
            _context57.prev = 92;
            _iterator32.f();
            return _context57.finish(92);
          case 95:
            // Dò tìm và thêm id_data_hd từ gethd vào recordset
            recordset.forEach(function (record) {
          ...
          case 107:
            _context57.prev = 107;
            _context57.t4 = _context57["catch"](102);
            console.error("L\u1ED7i khi x\xF3a d\u1EEF li\u1EC7u v\u1EDBi ID ".concat(record.id, ":"), _context57.t4);
          case 110:
            _context57.next = 100;
            break;
          case 112:
          ...
          case 114:
            _context57.prev = 114;
            _context57.t5 = _context57["catch"](98);
            _iterator33.e(_context57.t5);
          case 117:
            _context57.prev = 117;
            _iterator33.f();
            return _context57.finish(117);
          case 120:
            _context57.prev = 120;
            // insert lại thông tin mới    
          ...
          case 132:
            _context57.prev = 132;
            _context57.t6 = _context57["catch"](122);
            _iterator34.e(_context57.t6);
          case 135:
            _context57.prev = 135;
            _iterator34.f();
            return _context57.finish(135);
          case 138:
            _context57.next = 143;
            break;
          case 140:
            _context57.prev = 140;
            _context57.t7 = _context57["catch"](120);
            console.error("Lỗi khi insert vào DB:", _context57.t7);
          case 143:
            _context57.next = 168;
            break;
          case 145:
          ...
          case 157:
            _context57.prev = 157;
            _context57.t8 = _context57["catch"](147);
            _iterator35.e(_context57.t8);
          case 160:
            _context57.prev = 160;
            _iterator35.f();
            return _context57.finish(160);
          case 163:
            _context57.next = 168;
            break;
          case 165:
            _context57.prev = 165;
            _context57.t9 = _context57["catch"](145);
            console.error("Lỗi khi insert vào DB:", _context57.t9);
          case 168:
            _context57.prev = 168;
          ...
          case 180:
            _context57.prev = 180;
            _context57.t10 = _context57["catch"](170);
            _iterator36.e(_context57.t10);
          case 183:
            _context57.prev = 183;
            _iterator36.f();
            return _context57.finish(183);
          case 186:
            _context57.next = 191;
            break;
          case 188:
            _context57.prev = 188;
            _context57.t11 = _context57["catch"](168);
            console.error("Lỗi khi insert vào DB:", _context57.t11);
          case 191:
            _context57.next = 193;
          ...
          case 205:
            _context57.prev = 205;
            _context57.t12 = _context57["catch"](0);
            reject(_context57.t12);
          case 208:
          case "end":
            return _context57.stop();
        }
      }, _callee57, null, [[0, 205], [29, 45, 48, 51], [33, 38], [57, 89, 92, 95], [61, 82], [98, 114, 117, 120], [102, 107], [120, 140], [122, 132, 135, 138], [145, 165], [147, 157, 160, 163], [168, 188], [170, 180, 183, 186]]);
    }));
      ...
      return _regeneratorRuntime().wrap(function _callee63$(_context63) {
        while (1) switch (_context63.prev = _context63.next) {
          ...
          case 5:
            ...
            ngaytao = new Date();
            NamKiemKe = ngaytao.getFullYear(); //const NamKiemKe = 2024;
            request = _index["default"].sqlhis2Connection.request();
          ...
          case 47:
            _context63.prev = 47;
            _context63.t0 = _context63["catch"](42);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context63.t0.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể insert data kiểm kê'
            });
          ...
          case 55:
            _context63.prev = 55;
            _context63.t1 = _context63["catch"](38);
            _iterator37.e(_context63.t1);
          case 58:
            _context63.prev = 58;
            _iterator37.f();
            return _context63.finish(58);
          case 61:
            _context63.next = 63;
            return _index["default"].sequelize.query('CALL sp_get_dot_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:LanKiemKe,:NamKiemKe)', {
              replacements: {
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
                LanKiemKe: LanKiemKe + 1,
          ...
          case 76:
            _context63.prev = 76;
            _context63.t2 = _context63["catch"](71);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context63.t2.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể insert data kiểm kê'
            });
          ...
          case 84:
            _context63.prev = 84;
            _context63.t3 = _context63["catch"](67);
            _iterator38.e(_context63.t3);
          case 87:
            _context63.prev = 87;
            _iterator38.f();
            return _context63.finish(87);
          case 90:
            _context63.next = 96;
            break;
          case 92:
            _context63.prev = 92;
            _context63.t4 = _context63["catch"](65);
            console.error(_context63.t4);
          ...
          case 99:
            _getdata = _context63.sent;
            _context63.next = 102;
            return _index["default"].sequelize.query('CALL sp_get_duocda_kiemke_theonam(:KhoQuanLy,:LanKiemKe,:DotKiemKe_Id_Int,:NamKiemKe)', {
              replacements: {
                KhoQuanLy: KhoQuanLy,
                DotKiemKe_Id_Int: DotKiemKe_Id_Int,
                LanKiemKe: LanKiemKe + 1,
          ...
          case 126:
            _context63.prev = 126;
            _context63.t5 = _context63["catch"](114);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(dataItem.id), _context63.t5);
          case 129:
            _context63.next = 112;
            break;
          case 131:
          ...
          case 133:
            _context63.prev = 133;
            _context63.t6 = _context63["catch"](110);
            _iterator39.e(_context63.t6);
          case 136:
            _context63.prev = 136;
            _iterator39.f();
            return _context63.finish(136);
          case 139:
            _context63.next = 141;
            return _index["default"].sequelize.query('CALL sp_get_data_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id_Int)', {
              replacements: {
          ...
          case 150:
            ...
            _context63.next = 155;
            return _index["default"].sequelize.query('CALL sp_get_data_kiemke_khongcodotkiemke(:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id_Int,:NamKiemKe)', {
              replacements: {
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
          ...
          case 158:
            _getduocdakiem = _context63.sent;
          ...
          case 182:
            _context63.prev = 182;
            _context63.t7 = _context63["catch"](170);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(_dataItem.id), _context63.t7);
          case 185:
            _context63.next = 168;
            break;
          case 187:
          ...
          case 189:
            _context63.prev = 189;
            _context63.t8 = _context63["catch"](166);
            _iterator40.e(_context63.t8);
          case 192:
            _context63.prev = 192;
            _iterator40.f();
            return _context63.finish(192);
          case 195:
            _context63.next = 197;
            return _index["default"].sequelize.query('CALL sp_get_data_kiemke_khongcodotkiemke(:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id_Int,:NamKiemKe)', {
              replacements: {
          ...
          case 222:
            _context63.prev = 222;
            _context63.t9 = _context63["catch"](217);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context63.t9.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể insert data kiểm kê'
            });
          ...
          case 230:
            _context63.prev = 230;
            _context63.t10 = _context63["catch"](213);
            _iterator41.e(_context63.t10);
          case 233:
            _context63.prev = 233;
            _iterator41.f();
            return _context63.finish(233);
          case 236:
            _context63.next = 238;
            return _index["default"].sequelize.query('CALL sp_get_dot_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:LanKiemKe,:NamKiemKe)', {
              replacements: {
          ...
          case 238:
            _getDotKiemKe2 = _context63.sent;
          ...
          case 250:
            _context63.prev = 250;
            _context63.t11 = _context63["catch"](245);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            console.error("Error converting ngaypo:", _context63.t11.message);
            resolve({
              errCode: 1,
              errMessage: 'Không thể insert data kiểm kê'
            });
          ...
          case 258:
            _context63.prev = 258;
            _context63.t12 = _context63["catch"](241);
            _iterator42.e(_context63.t12);
          case 261:
            _context63.prev = 261;
            _iterator42.f();
            return _context63.finish(261);
          case 264:
            _context63.next = 270;
            break;
          case 266:
            _context63.prev = 266;
            _context63.t13 = _context63["catch"](204);
            console.error(_context63.t13);
            return _context63.abrupt("return", res.status(500).json({
              errCode: 500,
              errMessage: 'Internal Server Error'
            }));
          ...
          case 276:
            _getduocdakiem2 = _context63.sent;
          ...
          case 300:
            _context63.prev = 300;
            _context63.t14 = _context63["catch"](288);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(_dataItem2.id), _context63.t14);
          case 303:
            _context63.next = 286;
            break;
          case 305:
          ...
          case 307:
            _context63.prev = 307;
            _context63.t15 = _context63["catch"](284);
            _iterator43.e(_context63.t15);
          case 310:
            _context63.prev = 310;
            _iterator43.f();
            return _context63.finish(310);
          case 313:
            _context63.next = 315;
            return _index["default"].sequelize.query('CALL sp_get_data_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id_Int)', {
              replacements: {
          ...
          case 324:
            _getDotKiemKe3 = _context63.sent;
          ...
          case 332:
            _getduocdakiem3 = _context63.sent;
            ...
            //console.log('không có đợt int_plaingetdata', ketqua)
            //console.log('không có đợt int_plaingetduocdakiem', int_plaingetduocdakiem)
          ...
          case 356:
            _context63.prev = 356;
            _context63.t16 = _context63["catch"](344);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(_dataItem3.id), _context63.t16);
          case 359:
            _context63.next = 342;
            break;
          case 361:
          ...
          case 363:
            _context63.prev = 363;
            _context63.t17 = _context63["catch"](340);
            _iterator44.e(_context63.t17);
          case 366:
            _context63.prev = 366;
            _iterator44.f();
            return _context63.finish(366);
          case 369:
            _context63.next = 371;
            return _index["default"].sequelize.query('CALL sp_get_data_kiemke_khongcodotkiemke(:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id_Int,:NamKiemKe)', {
              replacements: {
          ...
          case 381:
            _context63.prev = 381;
            _context63.t18 = _context63["catch"](0);
            reject(_context63.t18);
          case 384:
          case "end":
            return _context63.stop();
        }
      }, _callee63, null, [[0, 381], [38, 55, 58, 61], [42, 47], [65, 92], [67, 84, 87, 90], [71, 76], [110, 133, 136, 139], [114, 126], [166, 189, 192, 195], [170, 182], [204, 266], [213, 230, 233, 236], [217, 222], [241, 258, 261, 264], [245, 250], [284, 307, 310, 313], [288, 300], [340, 363, 366, 369], [344, 356]]);
    }));
...
var getMaTaiSanKiemKe = function getMaTaiSanKiemKe(MaTaiSan, KhoTaiSan_Id, KhoQuanLy, UserId, DotKiemKe_Id, KhoaPhongHienTai) {
  return new Promise(/*#__PURE__*/function () {
    var _ref66 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee65(resolve, reject) {
      var _check_khoaphonghient, ngaytao, NamKiemKe, currentTime, data, check_khoaphonghientai, KhoaPhongHienTaiNew, _data$, _data$2, _checkdakiem_khackhoa, LanKiemKe, Duoc_Id, checkdakiem_khackhoa, MessageKhoaPhongSuDung, _iterator45, _step45, item, _data20, checkdakiem_theokhoa, _check_dotkiemke$, check_dotkiemke, _KhoaPhongHienTaiNew, _checklankiem$3, _data21$, _checkdakiem_khackhoa3, _ngaytao, _NamKiemKe, request, getdata, _data21, checklankiem, _LanKiemKe, _Duoc_Id, _checkdakiem_khackhoa2, _MessageKhoaPhongSuDung, _iterator46, _step46, _item25, DotKiemKe_Id_Int, _getdata5, getduocdakiem, plaingetdata, plaingetduocdakiem, int_plaingetdata, int_plaingetduocdakiem, ketqua, _iterator47, _step47, dataItem, _data22;
      return _regeneratorRuntime().wrap(function _callee65$(_context65) {
        while (1) switch (_context65.prev = _context65.next) {
          ...
          case 9:
            check_khoaphonghientai = _context65.sent;
            KhoaPhongHienTaiNew = (_check_khoaphonghient = check_khoaphonghientai[0]) === null || _check_khoaphonghient === void 0 ? void 0 : _check_khoaphonghient.KhoaPhongSuDung; //console.log('data', MaTaiSan, KhoTaiSan_Id, KhoQuanLy, DotKiemKe_Id)
            //console.log('data.length', data.length)
            if (!(data.length === 1)) {
              _context65.next = 57;
              break;
            }
            LanKiemKe = (_data$ = data[0]) === null || _data$ === void 0 ? void 0 : _data$.LanKiemKe;
            Duoc_Id = (_data$2 = data[0]) === null || _data$2 === void 0 ? void 0 : _data$2.Duoc_Id; //console.log('checklankiem', checklankiem, KhoTaiSan_Id)
            //console.log('checkdakiem_khackhoa', MaTaiSan, LanKiemKe == null ? 1 : LanKiemKe + 1, KhoQuanLy)
            _context65.next = 16;
            return _index["default"].sequelize.query('CALL sp_check_ma_dakiem_khackhoa(:MaTaiSan,:LanKiemKe,:KhoQuanLy,:Duoc_Id,:NamKiemKe)', {
              replacements: {
                MaTaiSan: MaTaiSan,
          ...
          case 16:
            checkdakiem_khackhoa = _context65.sent;
          ...
          case 30:
            _data20 = _context65.sent;
            if (!_data20) {
              _context65.next = 39;
              break;
            }
            _data20.IsCheckKiemKe = 1;
            _data20.SoLuongThucTe = item.SoLuong;
            _data20.ChenhLech = item.SoLuong - item.SoLuong;
          ...
          case 42:
            _context65.prev = 42;
            _context65.t0 = _context65["catch"](27);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context65.t0);
          case 45:
            _context65.next = 25;
            break;
          case 47:
          ...
          case 49:
            _context65.prev = 49;
            _context65.t1 = _context65["catch"](23);
            _iterator45.e(_context65.t1);
          case 52:
            _context65.prev = 52;
            _iterator45.f();
            return _context65.finish(52);
          case 55:
            _context65.next = 173;
            break;
          case 57:
            ...
            _context65.next = 60;
            return _index["default"].sequelize.query('CALL sp_check_ma_dakiem_theokhoa(:MaTaiSan,:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id,:NamKiemKe)', {
              replacements: {
                MaTaiSan: MaTaiSan,
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
          ...
          case 60:
            checkdakiem_theokhoa = _context65.sent;
          ...
          case 67:
            check_dotkiemke = _context65.sent;
            ...
            _ngaytao = new Date();
            _NamKiemKe = _ngaytao.getFullYear();
            request = _index["default"].sqlhis2Connection.request();
          ...
          case 78:
            ...
            return _index["default"].sequelize.query('CALL sp_checklan_kiemke(:KhoTaiSan_Id,:KhoQuanLy,:NamKiemKe)', {
              replacements: {
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
                NamKiemKe: _NamKiemKe
              },
              raw: false
            });
          case 82:
            checklankiem = _context65.sent;
            _LanKiemKe = (_checklankiem$3 = checklankiem[0]) === null || _checklankiem$3 === void 0 ? void 0 : _checklankiem$3.LanKiemKe;
            _Duoc_Id = (_data21$ = _data21[0]) === null || _data21$ === void 0 ? void 0 : _data21$.Duoc_Id; //console.log('checklankiem', checklankiem, KhoTaiSan_Id)
            //console.log('checkdakiem_khackhoa', MaTaiSan, LanKiemKe == null ? 1 : LanKiemKe + 1, KhoQuanLy)
            _context65.next = 87;
            return _index["default"].sequelize.query('CALL sp_check_ma_dakiem_khackhoa(:MaTaiSan,:LanKiemKe,:KhoQuanLy,:Duoc_Id,:NamKiemKe)', {
              replacements: {
          ...
          case 87:
            _checkdakiem_khackhoa2 = _context65.sent;
          ...
          case 97:
            ...
            return _index["default"].Data_KiemKe.create({
              ...
              ChenhLech: _item25.SoLuong - _item25.SoLuong,
              TrangThaiKiemKe: 0,
              IsCheckKiemKe: 1,
          ...
          case 104:
            _context65.prev = 104;
            _context65.t2 = _context65["catch"](99);
            // Nếu xảy ra lỗi, gửi thông báo lỗi về React
            //console.error("Error converting ngaypo:", error.message);
            resolve({
              errCode: 1,
          ...
          case 111:
            _context65.prev = 111;
            _context65.t3 = _context65["catch"](95);
            _iterator46.e(_context65.t3);
          case 114:
            _context65.prev = 114;
            _iterator46.f();
            return _context65.finish(114);
          case 117:
          ...
          case 147:
            _context65.prev = 147;
            _context65.t4 = _context65["catch"](135);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(dataItem.id), _context65.t4);
          case 150:
            _context65.next = 133;
            break;
          case 152:
          ...
          case 154:
            _context65.prev = 154;
            _context65.t5 = _context65["catch"](131);
            _iterator47.e(_context65.t5);
          case 157:
            _context65.prev = 157;
            _iterator47.f();
            return _context65.finish(157);
          case 160:
            resolve({
              errCode: 0,
              data: _data21,
          ...
          case 172:
            if (data.length > 1) {
              resolve({
                errCode: 1,
                errMessage: 'Mã tài sản đang trùng tại khoa, sử dụng mã tài sản mới để kiểm kê'
              });
            }
          case 173:
            _context65.next = 178;
          ...
          case 175:
            _context65.prev = 175;
            _context65.t6 = _context65["catch"](0);
            reject(_context65.t6);
          case 178:
          case "end":
            return _context65.stop();
        }
      }, _callee65, null, [[0, 175], [23, 49, 52, 55], [27, 42], [95, 111, 114, 117], [99, 104], [131, 154, 157, 160], [135, 147]]);
    }));
      ...
      return _regeneratorRuntime().wrap(function _callee66$(_context66) {
        while (1) switch (_context66.prev = _context66.next) {
          case 0:
            ...
            NamKiemKe = currentTime.getFullYear();
            _context66.next = 6;
          ...
          case 9:
            check_khoaphonghientai = _context66.sent;
            ...
            LanKiemKe = (_data$3 = data[0]) === null || _data$3 === void 0 ? void 0 : _data$3.LanKiemKe; //console.log('checklankiem', checklankiem, KhoTaiSan_Id)
            //console.log('checkdakiem_khackhoa', MaTaiSan, LanKiemKe == null ? 1 : LanKiemKe + 1, KhoQuanLy)
            _context66.next = 15;
            return _index["default"].sequelize.query('CALL sp_check_serial_dakiem_khackhoa(:Serial,:LanKiemKe,:KhoQuanLy,:NamKiemKe)', {
              replacements: {
                Serial: Serial,
                LanKiemKe: LanKiemKe == null ? 1 : LanKiemKe,
                KhoQuanLy: KhoQuanLy,
          ...
          case 15:
            checkdakiem_khackhoa = _context66.sent;
          ...
          case 29:
            _data23 = _context66.sent;
            if (!_data23) {
              _context66.next = 38;
              break;
            }
            _data23.IsCheckKiemKe = 1;
            _data23.SoLuongThucTe = item.SoLuong;
            _data23.ChenhLech = item.SoLuong - item.SoLuong;
          ...
          case 41:
            _context66.prev = 41;
            _context66.t0 = _context66["catch"](26);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context66.t0);
          case 44:
            _context66.next = 24;
            break;
          case 46:
          ...
          case 48:
            _context66.prev = 48;
            _context66.t1 = _context66["catch"](22);
            _iterator48.e(_context66.t1);
          case 51:
            _context66.prev = 51;
            _iterator48.f();
            return _context66.finish(51);
          case 54:
            _context66.next = 165;
            break;
          case 56:
            _context66.next = 58;
            return _index["default"].sequelize.query('CALL sp_check_serial_dakiem_theokhoa(:Serial,:KhoTaiSan_Id,:KhoQuanLy,:DotKiemKe_Id,:NamKiemKe)', {
              replacements: {
                Serial: Serial,
                KhoTaiSan_Id: KhoTaiSan_Id,
                KhoQuanLy: KhoQuanLy,
          ...
          case 58:
            checkdakiem_theokhoa = _context66.sent;
            if (!(checkdakiem_theokhoa.length > 0)) {
              _context66.next = 63;
              break;
            }
          ...
          case 65:
            check_dotkiemke = _context66.sent;
          ...
          case 82:
            _checkdakiem_khackhoa5 = _context66.sent;
          ...
          case 92:
            ...
            return _index["default"].Data_KiemKe.create({
              ...
              SoLuongThucTe: 1,
              ChenhLech: _item26.SoLuong - _item26.SoLuong,
              NgayKiemKe: currentTime,
          ...
          case 99:
            _context66.prev = 99;
            _context66.t2 = _context66["catch"](94);
            resolve({
              errCode: 1,
              errMessage: 'Không thể insert data kiểm kê'
            });
          ...
          case 106:
            _context66.prev = 106;
            _context66.t3 = _context66["catch"](90);
            _iterator49.e(_context66.t3);
          case 109:
            _context66.prev = 109;
            _iterator49.f();
            return _context66.finish(109);
          case 112:
            // TÌM XEM MÃ DƯỢC THUỘC PHÒNG BAN NÀO ĐỂ CẬP NHẠP LẠI TRẠNG THÁI CHUYỂN
            DotKiemKe_Id_Int = Number(DotKiemKe_Id);
            _context66.next = 115;
          ...
          case 142:
            _context66.prev = 142;
            _context66.t4 = _context66["catch"](130);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt id: ".concat(dataItem.id), _context66.t4);
          case 145:
            _context66.next = 128;
            break;
          case 147:
          ...
          case 149:
            _context66.prev = 149;
            _context66.t5 = _context66["catch"](126);
            _iterator50.e(_context66.t5);
          case 152:
            _context66.prev = 152;
            _iterator50.f();
            return _context66.finish(152);
          case 155:
            resolve({
              errCode: 0,
              data: _data24,
          ...
          case 167:
            _context66.prev = 167;
            _context66.t6 = _context66["catch"](0);
            reject(_context66.t6);
          case 170:
          case "end":
            return _context66.stop();
        }
      }, _callee66, null, [[0, 167], [22, 48, 51, 54], [26, 41], [90, 106, 109, 112], [94, 99], [126, 149, 152, 155], [130, 142]]);
    }));
    ...
    var _ref68 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee67(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee67$(_context67) {
        while (1) switch (_context67.prev = _context67.next) {
          ...
          case 12:
            check_log_chungtu = _context67.sent;
            _context67.next = 15;
            return _index["default"].Check_Data_ChungTu_Hd_Log.findAll({
              //attributes: ['SoBenhAn'],
              where: {
          ...
          case 15:
            check_log_hopdong = _context67.sent;
            _context67.next = 18;
          ...
          case 36:
            _context67.prev = 36;
            _context67.t0 = _context67["catch"](31);
            console.error("Error deleting record with", _context67.t0);
          case 39:
            _context67.next = 29;
            break;
          case 41:
          ...
          case 43:
            _context67.prev = 43;
            _context67.t1 = _context67["catch"](27);
            _iterator51.e(_context67.t1);
          case 46:
            _context67.prev = 46;
            _iterator51.f();
            return _context67.finish(46);
          case 49:
            _context67.next = 51;
            return _index["default"].Data_PO.findAll({
              //attributes: ['SoBenhAn'],
          ...
          case 80:
            _context67.prev = 80;
            _context67.t2 = _context67["catch"](59);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item31.id), _context67.t2);
          case 83:
            _context67.next = 57;
            break;
          case 85:
          ...
          case 87:
            _context67.prev = 87;
            _context67.t3 = _context67["catch"](55);
            _iterator52.e(_context67.t3);
          case 90:
            _context67.prev = 90;
            _iterator52.f();
            return _context67.finish(90);
          case 93:
            // Dò tìm và thêm id_data_hd từ gethd vào recordset
            recordset.forEach(function (record) {
              var found = getpo.find(function (po) {
          ...
          case 105:
            _context67.prev = 105;
            _context67.t4 = _context67["catch"](100);
            console.error("L\u1ED7i khi x\xF3a d\u1EEF li\u1EC7u v\u1EDBi ID ".concat(record.id, ":"), _context67.t4);
          case 108:
            _context67.next = 98;
            break;
          case 110:
          ...
          case 112:
            _context67.prev = 112;
            _context67.t5 = _context67["catch"](96);
            _iterator53.e(_context67.t5);
          case 115:
            _context67.prev = 115;
            _iterator53.f();
            return _context67.finish(115);
          case 118:
            _context67.prev = 118;
            // insert lại thông tin mới    
          ...
          case 130:
            _context67.prev = 130;
            _context67.t6 = _context67["catch"](120);
            _iterator54.e(_context67.t6);
          case 133:
            _context67.prev = 133;
            _iterator54.f();
            return _context67.finish(133);
          case 136:
            _context67.next = 141;
            break;
          case 138:
            _context67.prev = 138;
            _context67.t7 = _context67["catch"](118);
            console.error("Lỗi khi insert vào DB:", _context67.t7);
          case 141:
          ...
          case 144:
            data_check_log_chungtu = _context67.sent;
            _context67.next = 147;
            return _index["default"].Data_ChungTu_Log.findAll({
          ...
          case 147:
            data_log_chungtu = _context67.sent;
            //console.log('data_check_log_chungtu', data_check_log_chungtu)
            //console.log('data_log_chungtu', data_log_chungtu)
            result = data_check_log_chungtu.map(function (itemCheck) {
              var matchedItem = data_log_chungtu.find(function (itemLog) {
          ...
          case 166:
            _context67.prev = 166;
            _context67.t8 = _context67["catch"](154);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item27.id), _context67.t8);
          case 169:
            _context67.next = 152;
            break;
          case 171:
          ...
          case 173:
            _context67.prev = 173;
            _context67.t9 = _context67["catch"](150);
            _iterator55.e(_context67.t9);
          case 176:
            _context67.prev = 176;
            _iterator55.f();
            return _context67.finish(176);
          case 179:
            _context67.next = 242;
            break;
          case 181:
          ...
          case 193:
            _context67.prev = 193;
            _context67.t10 = _context67["catch"](183);
            _iterator56.e(_context67.t10);
          case 196:
            _context67.prev = 196;
            _iterator56.f();
            return _context67.finish(196);
          case 199:
            _context67.next = 204;
            break;
          case 201:
            _context67.prev = 201;
            _context67.t11 = _context67["catch"](181);
            console.error("Lỗi khi insert vào DB:", _context67.t11);
          case 204:
            //SO SÁNH LẦN CHECK LOG CT 1 VÀ CHECK LOG CT 2 ĐỀ TÌM RA KHÁC NHAU
          ...
          case 207:
            _data_check_log_chungtu2 = _context67.sent;
            _context67.next = 210;
            return _index["default"].Data_ChungTu_Log.findAll({
              attributes: ['id_data_po', 'mataisan', 'soluongnhap_check', 'dongianhap_check', 'dongianhapvat_check'],
              where: {
          ...
          case 210:
            _data_log_chungtu2 = _context67.sent;
            //console.log('data_check_log_chungtu', data_check_log_chungtu)
            //console.log('data_log_chungtu', data_log_chungtu)
          ...
          case 229:
            _context67.prev = 229;
            _context67.t12 = _context67["catch"](217);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item29.id), _context67.t12);
          case 232:
            _context67.next = 215;
            break;
          case 234:
          ...
          case 236:
            _context67.prev = 236;
            _context67.t13 = _context67["catch"](213);
            _iterator57.e(_context67.t13);
          case 239:
            _context67.prev = 239;
            _iterator57.f();
            return _context67.finish(239);
          case 242:
            _context67.prev = 242;
          ...
          case 254:
            _context67.prev = 254;
            _context67.t14 = _context67["catch"](244);
            _iterator58.e(_context67.t14);
          case 257:
            _context67.prev = 257;
            _iterator58.f();
            return _context67.finish(257);
          case 260:
            _context67.next = 265;
            break;
          case 262:
            _context67.prev = 262;
            _context67.t15 = _context67["catch"](242);
            console.error("Lỗi khi insert vào DB:", _context67.t15);
          case 265:
            _context67.next = 267;
          ...
          case 279:
            _context67.prev = 279;
            _context67.t16 = _context67["catch"](0);
            reject(_context67.t16);
          case 282:
          case "end":
            return _context67.stop();
        }
      }, _callee67, null, [[0, 279], [27, 43, 46, 49], [31, 36], [55, 87, 90, 93], [59, 80], [96, 112, 115, 118], [100, 105], [118, 138], [120, 130, 133, 136], [150, 173, 176, 179], [154, 166], [181, 201], [183, 193, 196, 199], [213, 236, 239, 242], [217, 229], [242, 262], [244, 254, 257, 260]]);
    }));
    ...
    var _ref74 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee73(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee73$(_context73) {
        while (1) switch (_context73.prev = _context73.next) {
          ...
          case 4:
            check_mataisan_dm = _context73.sent;
            //console.log('check_mataisan_dm', check_mataisan_dm)
            resolve(check_mataisan_dm);
            _context73.next = 11;
            break;
    ...
    var _ref75 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee74(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee74$(_context74) {
        while (1) switch (_context74.prev = _context74.next) {
          ...
          case 4:
            check_mataisan_dm = _context74.sent;
            //console.log('check_mataisan_dm', check_mataisan_dm)
            resolve(check_mataisan_dm);
            _context74.next = 11;
            break;
    ...
    var _ref76 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee75(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee75$(_context75) {
        while (1) switch (_context75.prev = _context75.next) {
          ...
          case 3:
            check_mataisan_dm = _context75.sent;
            //console.log('check_mataisan_dm', check_mataisan_dm)
            resolve(check_mataisan_dm);
            _context75.next = 10;
            break;
    ...
    var _ref77 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee76(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee76$(_context76) {
        while (1) switch (_context76.prev = _context76.next) {
          ...
          case 3:
            check_tentaisan_dm = _context76.sent;
    ...
    var _ref78 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee77(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee77$(_context77) {
        while (1) switch (_context77.prev = _context77.next) {
          ...
          case 3:
            check_tentaisan_dm = _context77.sent;
            resolve(check_tentaisan_dm);
            //console.log('check_mataisan_dm', check_mataisan_dm)
            _context77.next = 10;
            break;
    ...
    var _ref79 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee78(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee78$(_context78) {
        while (1) switch (_context78.prev = _context78.next) {
          ...
          case 3:
            check_tentaisan_dm = _context78.sent;
            resolve(check_tentaisan_dm);
            //console.log('check_mataisan_dm', check_mataisan_dm)
            _context78.next = 10;
            break;
    ...
    var _ref80 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee79(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee79$(_context79) {
        while (1) switch (_context79.prev = _context79.next) {
          ...
          case 34:
            _result_editma = _context79.sent;
          ...
          case 55:
            _context79.prev = 55;
            _context79.t0 = _context79["catch"](43);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context79.t0);
          case 58:
            _context79.next = 41;
            break;
          case 60:
          ...
          case 62:
            _context79.prev = 62;
            _context79.t1 = _context79["catch"](39);
            _iterator59.e(_context79.t1);
          case 65:
            _context79.prev = 65;
            _iterator59.f();
            return _context79.finish(65);
          case 68:
            resolve({
              errCode: 0,
          ...
          case 82:
            _result_editma2 = _context79.sent;
          ...
          case 106:
            _result_editma3 = _context79.sent;
            // Hàm dò tìm và cập nhật checkmataisan
          ...
          case 127:
            _context79.prev = 127;
            _context79.t2 = _context79["catch"](115);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item32.id), _context79.t2);
          case 130:
            _context79.next = 113;
            break;
          case 132:
          ...
          case 134:
            _context79.prev = 134;
            _context79.t3 = _context79["catch"](111);
            _iterator60.e(_context79.t3);
          case 137:
            _context79.prev = 137;
            _iterator60.f();
            return _context79.finish(137);
          case 140:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập mã tài sản thành công'
          ...
          case 154:
            _result_editma4 = _context79.sent;
          ...
          case 179:
            _result_editma5 = _context79.sent;
            // Gọi hàm updateCheckMataisan
          ...
          case 199:
            _context79.prev = 199;
            _context79.t4 = _context79["catch"](187);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item33.id), _context79.t4);
          case 202:
            _context79.next = 185;
            break;
          case 204:
          ...
          case 206:
            _context79.prev = 206;
            _context79.t5 = _context79["catch"](183);
            _iterator61.e(_context79.t5);
          case 209:
            _context79.prev = 209;
            _iterator61.f();
            return _context79.finish(209);
          case 212:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập mã tài sản thành công'
          ...
          case 218:
            _context79.prev = 218;
            _context79.t6 = _context79["catch"](0);
            reject(_context79.t6);
          case 221:
          case "end":
            return _context79.stop();
        }
      }, _callee79, null, [[0, 218], [39, 62, 65, 68], [43, 55], [111, 134, 137, 140], [115, 127], [183, 206, 209, 212], [187, 199]]);
    }));
...
var editKhoaPhongHienTai = function editKhoaPhongHienTai(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref81 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee80(resolve, reject) {
      var dataArray, _iterator62, _step62, item, _data32, _dataArray, _iterator63, _step63, _item34, _data33, _dataArray2, _iterator64, _step64, _item35, _data34, _dataArray3, _iterator65, _step65, _item36, _data35, _dataArray4, _iterator66, _step66, _item37, _data36;
      return _regeneratorRuntime().wrap(function _callee80$(_context80) {
        while (1) switch (_context80.prev = _context80.next) {
          ...
          case 19:
            _context80.prev = 19;
            _context80.t0 = _context80["catch"](9);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt Data ki\u1EC3m k\xEA c\xF3 id: ".concat(item.id), _context80.t0);
          case 22:
            _context80.next = 7;
            break;
          case 24:
          ...
          case 26:
            ...
            _iterator62.e(_context80.t1);
          case 29:
            _context80.prev = 29;
            _iterator62.f();
            return _context80.finish(29);
          case 32:
            resolve({
              errCode: 0,
          ...
          case 53:
            _context80.prev = 53;
            _context80.t2 = _context80["catch"](43);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt Data ki\u1EC3m k\xEA c\xF3 id: ".concat(_item34.id), _context80.t2);
          case 56:
            _context80.next = 41;
            break;
          case 58:
          ...
          case 60:
            _context80.prev = 60;
            _context80.t3 = _context80["catch"](39);
            _iterator63.e(_context80.t3);
          case 63:
            _context80.prev = 63;
            _iterator63.f();
            return _context80.finish(63);
          case 66:
            resolve({
              errCode: 0,
          ...
          case 80:
            _data34 = _context80.sent;
            if (!_data34) {
              _context80.next = 86;
              break;
            }
            _data34.NguoiSuDung = _item35.NguoiSuDung;
            _data34.NguoiSuDung_Id = _item35.NguoiSuDung_Id;
            // Lưu thay đổi
            _context80.next = 86;
            return _data34.save();
          case 86:
          ...
          case 88:
            _context80.prev = 88;
            _context80.t4 = _context80["catch"](77);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt Data ki\u1EC3m k\xEA c\xF3 id: ".concat(_item35.id), _context80.t4);
          case 91:
            _context80.next = 75;
            break;
          case 93:
          ...
          case 95:
            _context80.prev = 95;
            _context80.t5 = _context80["catch"](73);
            _iterator64.e(_context80.t5);
          case 98:
            _context80.prev = 98;
            _iterator64.f();
            return _context80.finish(98);
          case 101:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập người sử dụng thành công'
            });
            _context80.next = 170;
            break;
          case 104:
          ...
          case 115:
            _data35 = _context80.sent;
            if (!_data35) {
              _context80.next = 120;
              break;
            }
            _data35.GhiChuHienTai = _item36.GhiChuHienTai;
            // Lưu thay đổi
            _context80.next = 120;
            return _data35.save();
          case 120:
          ...
          case 122:
            _context80.prev = 122;
            _context80.t6 = _context80["catch"](112);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt Data ki\u1EC3m k\xEA c\xF3 id: ".concat(_item36.id), _context80.t6);
          case 125:
            _context80.next = 110;
            break;
          case 127:
          ...
          case 129:
            _context80.prev = 129;
            _context80.t7 = _context80["catch"](108);
            _iterator65.e(_context80.t7);
          case 132:
            _context80.prev = 132;
            _iterator65.f();
            return _context80.finish(132);
          case 135:
            resolve({
              errCode: 0,
          ...
          case 138:
            ...
            _dataArray4 = [data];
            if (!(_dataArray4.length > 0)) {
              _context80.next = 169;
              break;
            }
            //console.log('check data dataArray', dataArray)
            _iterator66 = _createForOfIteratorHelper(_dataArray4);
            _context80.prev = 142;
            _iterator66.s();
          case 144:
          ...
          case 149:
            _data36 = _context80.sent;
            if (!_data36) {
              _context80.next = 154;
              break;
            }
            _data36.TinhTrang = _item37.TinhTrang;
            // Lưu thay đổi
            _context80.next = 154;
            return _data36.save();
          case 154:
          ...
          case 156:
            _context80.prev = 156;
            _context80.t8 = _context80["catch"](146);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt Data ki\u1EC3m k\xEA c\xF3 id: ".concat(_item37.id), _context80.t8);
          case 159:
            _context80.next = 144;
            break;
          case 161:
          ...
          case 163:
            _context80.prev = 163;
            _context80.t9 = _context80["catch"](142);
            _iterator66.e(_context80.t9);
          case 166:
            _context80.prev = 166;
            _iterator66.f();
            return _context80.finish(166);
          case 169:
            resolve({
              errCode: 0,
          ...
          case 172:
            _context80.prev = 172;
            _context80.t10 = _context80["catch"](0);
            reject(_context80.t10);
          case 175:
          case "end":
            return _context80.stop();
        }
      }, _callee80, null, [[0, 172], [5, 26, 29, 32], [9, 19], [39, 60, 63, 66], [43, 53], [73, 95, 98, 101], [77, 88], [108, 129, 132, 135], [112, 122], [142, 163, 166, 169], [146, 156]]);
    }));
...
var editMaTaiSan = function editMaTaiSan(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref82 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee81(resolve, reject) {
      var currentTime, checkedit, result_editma, request, mataisan, getdata, recordset, dataedit, _result_editma6, updateCheckMataisan, updatedCheckMataisan, _iterator67, _step67, item, _data37, _checkedit3, result_editten, _request5, tentaisan, _getdata9, _recordset3, _dataedit3, _result_editten, updateCheckTentaisan, updatedCheckTentaisan, _iterator68, _step68, _item38, _data38, _checkedit4, _dataedit4, _checkedit5, _dataedit5, _checkedit6, _dataedit6, _checkedit7, _result_editma7, _request6, _mataisan3, _getdata10, _recordset4, _dataedit7, _result_editma8, _updateCheckMataisan3, _updatedCheckMataisan3, _iterator69, _step69, _item39, _data39, _checkedit8, _result_editten2, _request7, _tentaisan, _getdata11, _recordset5, _dataedit8, _result_editten3, _updateCheckTentaisan, _updatedCheckTentaisan, _iterator70, _step70, _item40, _data40, _checkedit9, _result_editma9, _request8, _mataisan4, _getdata12, _recordset6, _updateCheckMataisan4, _dataedit9, _result_editma10, _updatedCheckMataisan4, _iterator71, _step71, _item41, _data41, _checkedit10, _result_editten4, _request9, _tentaisan2, _getdata13, _recordset7, _dataedit10, _result_editten5, _updateCheckTentaisan2, _updatedCheckTentaisan2, _iterator72, _step72, _item42, _data42, _checkedit11, _request10, nhacungcap_id, _getdata14, _recordset8, datancc, _dataedit11;
      return _regeneratorRuntime().wrap(function _callee81$(_context81) {
        while (1) switch (_context81.prev = _context81.next) {
          ...
          case 33:
            ...
            return updateMaTaiSanPO(data.mataisanNew, data.sopo);
          case 35:
            _result_editma6 = _context81.sent;
            //console.log('result_editma', result_editma)
            ...
            _iterator67 = _createForOfIteratorHelper(updatedCheckMataisan);
            _context81.prev = 40;
            _iterator67.s();
          case 42:
          ...
          case 47:
            _data37 = _context81.sent;
            if (!_data37) {
              _context81.next = 54;
              break;
            }
            _data37.checkma = item.checkma;
            _data37.tentaisan = item.tentaisan;
            _data37.checkten = 1;
            // Lưu thay đổi
            _context81.next = 54;
            return _data37.save();
          ...
          case 56:
            _context81.prev = 56;
            _context81.t0 = _context81["catch"](44);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(item.id), _context81.t0);
          case 59:
            _context81.next = 42;
            break;
          case 61:
          ...
          case 63:
            _context81.prev = 63;
            _context81.t1 = _context81["catch"](40);
            _iterator67.e(_context81.t1);
          case 66:
            _context81.prev = 66;
            _iterator67.f();
          ...
          case 82:
            result_editten = _context81.sent;
          ...
          case 105:
            ...
            return updateTenTaiSanPO(data.tentaisanNew, data.sopo);
          case 107:
            _result_editten = _context81.sent;
            // Hàm dò tìm và cập nhật checkmataisan
            ...
            _iterator68 = _createForOfIteratorHelper(updatedCheckTentaisan);
            _context81.prev = 112;
            _iterator68.s();
          case 114:
          ...
          case 119:
            _data38 = _context81.sent;
            if (!_data38) {
              _context81.next = 124;
              break;
            }
            _data38.checkten = _item38.checkten;
            // Lưu thay đổi
            _context81.next = 124;
            return _data38.save();
          case 124:
          ...
          case 126:
            _context81.prev = 126;
            _context81.t2 = _context81["catch"](116);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item38.id), _context81.t2);
          case 129:
            _context81.next = 114;
            break;
          case 131:
          ...
          case 133:
            _context81.prev = 133;
            _context81.t3 = _context81["catch"](112);
            _iterator68.e(_context81.t3);
          case 136:
            _context81.prev = 136;
            _iterator68.f();
            return _context81.finish(136);
          case 139:
            resolve({
              errCode: 0,
          ...
          case 214:
            _result_editma7 = _context81.sent;
          ...
          case 237:
            ...
            return updateMaTaiSanPR(data.mataisanNew, data.sopr);
          case 239:
            _result_editma8 = _context81.sent;
            // Hàm dò tìm và cập nhật checkmataisan
            ...
            _iterator69 = _createForOfIteratorHelper(_updatedCheckMataisan3);
            _context81.prev = 244;
            _iterator69.s();
          case 246:
          ...
          case 251:
            _data39 = _context81.sent;
            if (!_data39) {
              _context81.next = 258;
              break;
            }
            _data39.checkma = _item39.checkma;
            _data39.tentaisan = _item39.tentaisan;
            _data39.checkten = 1;
            // Lưu thay đổi
            _context81.next = 258;
            return _data39.save();
          ...
          case 260:
            _context81.prev = 260;
            _context81.t4 = _context81["catch"](248);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item39.id), _context81.t4);
          case 263:
            _context81.next = 246;
            break;
          case 265:
          ...
          case 267:
            _context81.prev = 267;
            _context81.t5 = _context81["catch"](244);
            _iterator69.e(_context81.t5);
          case 270:
            _context81.prev = 270;
            _iterator69.f();
            return _context81.finish(270);
          case 273:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập mã tài sản thành công'
          ...
          case 286:
            _result_editten2 = _context81.sent;
          ...
          case 309:
            ...
            return updateTenTaiSanPR(data.tentaisanNew, data.sopr);
          case 311:
            _result_editten3 = _context81.sent;
            // Hàm dò tìm và cập nhật checkmataisan
            ...
            _iterator70 = _createForOfIteratorHelper(_updatedCheckTentaisan);
            _context81.prev = 316;
            _iterator70.s();
          case 318:
          ...
          case 323:
            _data40 = _context81.sent;
            if (!_data40) {
              _context81.next = 328;
              break;
            }
            _data40.checkten = _item40.checkten;
            // Lưu thay đổi
            _context81.next = 328;
            return _data40.save();
          case 328:
          ...
          case 330:
            _context81.prev = 330;
            _context81.t6 = _context81["catch"](320);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item40.id), _context81.t6);
          case 333:
            _context81.next = 318;
            break;
          case 335:
          ...
          case 337:
            _context81.prev = 337;
            _context81.t7 = _context81["catch"](316);
            _iterator70.e(_context81.t7);
          case 340:
            _context81.prev = 340;
            _iterator70.f();
            return _context81.finish(340);
          case 343:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập tên tài sản thành công'
          ...
          case 353:
            ...
            return updateMaTaiSan(data.mataisanNew, data.nhacungcap_id);
          case 357:
            _result_editma9 = _context81.sent;
          ...
          case 381:
            ...
            return updateMaTaiSan(data.mataisanNew, data.nhacungcap_id);
          case 383:
            _result_editma10 = _context81.sent;
            // Gọi hàm updateCheckMataisan
            ...
            _iterator71 = _createForOfIteratorHelper(_updatedCheckMataisan4);
            _context81.prev = 387;
            _iterator71.s();
          case 389:
          ...
          case 394:
            _data41 = _context81.sent;
            if (!_data41) {
              _context81.next = 401;
              break;
            }
            _data41.checkma = _item41.checkma;
            _data41.tentaisan = _item41.tentaisan;
            _data41.checkten = 1;
            // Lưu thay đổi
            _context81.next = 401;
            return _data41.save();
          ...
          case 403:
            _context81.prev = 403;
            _context81.t8 = _context81["catch"](391);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item41.id), _context81.t8);
          case 406:
            _context81.next = 389;
            break;
          case 408:
          ...
          case 410:
            _context81.prev = 410;
            _context81.t9 = _context81["catch"](387);
            _iterator71.e(_context81.t9);
          case 413:
            _context81.prev = 413;
            _iterator71.f();
            return _context81.finish(413);
          case 416:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập mã tài sản thành công'
          ...
          case 429:
            _result_editten4 = _context81.sent;
          ...
          case 452:
            ...
            return updateTenTaiSan(data.tentaisanNew, data.nhacungcap_id);
          case 454:
            _result_editten5 = _context81.sent;
            // Hàm dò tìm và cập nhật checkmataisan
            ...
            _iterator72 = _createForOfIteratorHelper(_updatedCheckTentaisan2);
            _context81.prev = 459;
            _iterator72.s();
          case 461:
          ...
          case 466:
            _data42 = _context81.sent;
            if (!_data42) {
              _context81.next = 471;
              break;
            }
            _data42.checkten = _item42.checkten;
            // Lưu thay đổi
            _context81.next = 471;
            return _data42.save();
          case 471:
          ...
          case 473:
            _context81.prev = 473;
            _context81.t10 = _context81["catch"](463);
            console.error("L\u1ED7i khi c\u1EADp nh\u1EADt PO c\xF3 id: ".concat(_item42.id), _context81.t10);
          case 476:
            _context81.next = 461;
            break;
          case 478:
          ...
          case 480:
            _context81.prev = 480;
            _context81.t11 = _context81["catch"](459);
            _iterator72.e(_context81.t11);
          case 483:
            _context81.prev = 483;
            _iterator72.f();
            return _context81.finish(483);
          case 486:
            resolve({
              errCode: 0,
              errMessage: 'Cập nhập tên tài sản thành công'
          ...
          case 524:
            _context81.prev = 524;
            _context81.t12 = _context81["catch"](0);
            reject(_context81.t12);
          case 527:
          case "end":
            return _context81.stop();
        }
      }, _callee81, null, [[0, 524], [40, 63, 66, 69], [44, 56], [112, 133, 136, 139], [116, 126], [244, 267, 270, 273], [248, 260], [316, 337, 340, 343], [320, 330], [387, 410, 413, 416], [391, 403], [459, 480, 483, 486], [463, 473]]);
    }));
...
var getOneHD = function getOneHD(machungtu) {
  return new Promise(/*#__PURE__*/function () {
    var _ref86 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee85(resolve, reject) {
...
var getOnePR = function getOnePR(sopo) {
  return new Promise(/*#__PURE__*/function () {
    var _ref87 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee86(resolve, reject) {
...
var getDataDaKiemKe = function getDataDaKiemKe(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref88 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee87(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee87$(_context87) {
        while (1) switch (_context87.prev = _context87.next) {
          ...
          case 4:
            ...
            return _context87.abrupt("break", 12);
          case 9:
            _i++;
            _context87.next = 4;
            break;
...
module.exports = {
  ...
  getAllNguoiSuDung: getAllNguoiSuDung,
  getCheckDongBo: getCheckDongBo,
