...
var getAllPhongBan = function getAllPhongBan() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _index["default"].Dm_PhongBan.findAll();
          case 4:
            phongban = _context.sent;
...
var getAllPhongBanHis = function getAllPhongBanHis() {
  return new Promise(/*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var request, getphongban, phongban;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return request.execute('[QLCV_GetPhongBan]');
          case 4:
            getphongban = _context2.sent;
            phongban = getphongban.recordset.map(function (record) {
...
var getPhongBanId = function getPhongBanId(data) {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _index["default"].sequelize.query('CALL sp_get_phongban_id(:phongban_id)', {
              replacements: {
                phongban_id: 20
              },
              raw: true
...
var checkPhongBan = function checkPhongBan(TenPhongBan) {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _index["default"].Dm_PhongBan.findOne({
              where: {
                TenPhongBan: TenPhongBan
              }
            });
          case 3:
            phongban = _context4.sent;
            if (phongban) {
              resolve(true);
            } else {
              resolve(false);
...
var createNewPhongBan = function createNewPhongBan(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var check, validationRules, errorMessage, _i, _validationRules, rule;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return checkPhongBan(data.tenphongban);
          case 3:
          ...
          case 23:
            _context5.next = 25;
            return _index["default"].Dm_PhongBan.create({
...
var editPhongBan = function editPhongBan(data) {
...
var deletePhongBan = function deletePhongBan(id) {
  return new Promise(/*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 3:
            phongban = _context7.sent;
            if (!phongban) {
              resolve({
                errCode: 2,
                errMessage: "Ph\xF2ng ban kh\xF4ng t\u1ED3n t\u1EA1i"
              });
            }
            _context7.next = 7;
            return _index["default"].Dm_PhongBan.destroy({
              where: {
                id: id
              }
            });
...
var checkXoaPhongBan = function checkXoaPhongBan(id) {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            _context8.next = 3;
            return _index["default"].sequelize.query('CALL sp_get_checkxoa_phongban(:PhongBan_Id)', {
              replacements: {
                PhongBan_Id: id
              },
              raw: true
