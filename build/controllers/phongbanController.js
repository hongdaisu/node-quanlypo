...
var handleGetAllPhongBan = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _phongbanService["default"].getAllPhongBan();
        case 3:
  ...
  return function handleGetAllPhongBan(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetAllPhongBanHis = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _phongbanService["default"].getAllPhongBanHis();
        case 3:
          phongban = _context2.sent;
  ...
  return function handleGetAllPhongBanHis(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleGetPhongBanId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _phongbanService["default"].getPhongBanId(20);
        case 3:
          phongban = _context3.sent;
  ...
  return function handleGetPhongBanId(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleCreateNewPhongBan = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          data = req.body;
          _context4.next = 4;
          return _phongbanService["default"].createNewPhongBan(data);
        case 4:
  ...
  return function handleCreateNewPhongBan(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleEditPhongBan = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 4;
          return _phongbanService["default"].editPhongBan(data);
        case 4:
  ...
  return function handleEditPhongBan(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var handleDeletePhongBan = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          _context6.next = 6;
          return _phongbanService["default"].deletePhongBan(id);
        case 6:
  ...
  return function handleDeletePhongBan(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var handleCheckXoaPhongBan = /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    _context7.prev = 0;
                    _context7.next = 3;
                    return _phongbanService["default"].checkXoaPhongBan(id);
                  case 3:
  ...
  return function handleCheckXoaPhongBan(_x13, _x14) {
