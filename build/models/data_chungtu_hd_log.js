...
module.exports = function (sequelize, DataTypes) {
  var Data_ChungTu_Hd_Log = /*#__PURE__*/function (_Model) {
    function Data_ChungTu_Hd_Log() {
      _classCallCheck(this, Data_ChungTu_Hd_Log);
      return _callSuper(this, Data_ChungTu_Hd_Log, arguments);
    }
    _inherits(Data_ChungTu_Hd_Log, _Model);
    return _createClass(Data_ChungTu_Hd_Log);
  }(Model);
  ;
  Data_ChungTu_Hd_Log.init({
    ...
    sequelize: sequelize,
    modelName: 'Data_ChungTu_Hd_Log'
  });
  return Data_ChungTu_Hd_Log;
};