...
module.exports = function (sequelize, DataTypes) {
  var Data_PO = /*#__PURE__*/function (_Model) {
    function Data_PO() {
      _classCallCheck(this, Data_PO);
      return _callSuper(this, Data_PO, arguments);
    }
    _inherits(Data_PO, _Model);
    return _createClass(Data_PO);
  }(Model);
  ;
  Data_PO.init({
