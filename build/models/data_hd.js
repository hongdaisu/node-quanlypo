...
module.exports = function (sequelize, DataTypes) {
  var Data_HD = /*#__PURE__*/function (_Model) {
    function Data_HD() {
      _classCallCheck(this, Data_HD);
      return _callSuper(this, Data_HD, arguments);
    }
    _inherits(Data_HD, _Model);
    return _createClass(Data_HD);
  }(Model);
  ;
  Data_HD.init({
