...
module.exports = function (sequelize, DataTypes) {
  var Data_PR = /*#__PURE__*/function (_Model) {
    function Data_PR() {
      _classCallCheck(this, Data_PR);
      return _callSuper(this, Data_PR, arguments);
    }
    _inherits(Data_PR, _Model);
    return _createClass(Data_PR);
  }(Model);
  ;
  Data_PR.init({
