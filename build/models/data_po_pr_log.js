...
module.exports = function (sequelize, DataTypes) {
  var Data_Po_Pr_Log = /*#__PURE__*/function (_Model) {
    function Data_Po_Pr_Log() {
      _classCallCheck(this, Data_Po_Pr_Log);
      return _callSuper(this, Data_Po_Pr_Log, arguments);
    }
    _inherits(Data_Po_Pr_Log, _Model);
    return _createClass(Data_Po_Pr_Log);
  }(Model);
  ;
  Data_Po_Pr_Log.init({
