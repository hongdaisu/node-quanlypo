...
module.exports = function (sequelize, DataTypes) {
  var Data_ChungTu = /*#__PURE__*/function (_Model) {
    function Data_ChungTu() {
      _classCallCheck(this, Data_ChungTu);
      return _callSuper(this, Data_ChungTu, arguments);
    }
    _inherits(Data_ChungTu, _Model);
    return _createClass(Data_ChungTu);
  }(Model);
  ;
  Data_ChungTu.init({
